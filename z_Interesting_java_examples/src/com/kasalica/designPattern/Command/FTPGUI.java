...
public class FTPGUI extends JFrame {
  ...
  public FTPGUI() throws Exception {
    ...
    localList = new JList<String>(defLocalList);
    remoteList = new JList<String>(defRemoteList);
    setPnlFTPUI(new JPanel());
    ...
    ButtonHandler vf = new ButtonHandler(localList, remoteList);
...
public JPanel getPnlFTPUI() {
	return pnlFTPUI;
}

public void setPnlFTPUI(JPanel pnlFTPUI) {
	this.pnlFTPUI = pnlFTPUI;
}
